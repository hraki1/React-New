...
<div className="container">
  <div className="card-deck mb-3 d-flex text-center">
    <div className="card ms-auto mb-4 shadow-sm border-primary">
    ...
    <div className="card m-3 mb-4 shadow-sm border-primary">
      <div className="card-header border-primary">
  ...
  <small className="text-muted">/ mo</small></h1>
    ...
    <div className="card mb-4 shadow-sm border-primary">
      ...
      <div className="card-body">
        ...
        <button type="button" className="btn btn-lg btn-primary btn-primary">Contact us</button>
      </div>
    </div>
  </div>
